...
//!
//! Note that in Section 4, only 4O can be fully automatically determined and we do not have
//! support for any automatic annotation for Section 5.  We only provide data structures for
//! storing sections where we can provide automatic annotation.
